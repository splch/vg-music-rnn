...
tf.app.flags.DEFINE_string('output_file', None,'Path to output TFRecord file.')
tf.app.flags.DEFINE_bool('recursive', False,'Recurse into subdirectories?')
tf.app.flags.DEFINE_integer('num_threads', 1,'Number of threads in parallel.')
